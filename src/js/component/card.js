        ...
        <div className="col-2">
            <div className="card" style={{width: "18rem"}}>
                ...
                <div className="card-body">
                    ...
                    <div className="like">
                        <Link to={'/character/'+charSelected}><button type="button" className="btn btn-secondary">View</button></Link>
                        <button type="button" className="ms-2 btn btn-primary" onClick={()=>{actions.addToFavorites(character?.name)}}>
